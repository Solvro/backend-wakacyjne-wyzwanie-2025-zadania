  ...
  const createdTrips = await Promise.all([
    ...
    prisma.trip.create({
      data: {
        ...
        endDate: new Date("2025-08-12T16:00:00Z"),
  ...
  const createdActivities = await Promise.all([
    prisma.activity.create({
      data: {
        ...
        startDate: new Date("2025-07-16T10:00:00Z"),
    ...
    prisma.activity.create({
      data: {
        ...
        startDate: new Date("2025-07-16T14:00:00Z"),
        endDate: new Date("2025-07-16T17:00:00Z"),
    ...
    prisma.activity.create({
      data: {
        ...
        startDate: new Date("2025-07-18T21:00:00Z"),
        endDate: new Date("2025-07-18T23:00:00Z"),
    ...
    prisma.activity.create({
      data: {
        ...
        place: "Berlin Congress Center",
        startDate: new Date("2025-09-11T10:00:00Z"),
    ...
    prisma.activity.create({
      data: {
        ...
        startDate: new Date("2025-09-11T18:00:00Z"),
        endDate: new Date("2025-09-11T19:30:00Z"),
        category: ActivityCategory.SIGHTSEEING,
        tripId: createdTrips[1].id,
        participants: {
          connect: [
    ...
    prisma.activity.create({
      data: {
        ...
        startDate: new Date("2025-06-02T08:00:00Z"),
        endDate: new Date("2025-06-02T16:00:00Z"),
    ...
    prisma.activity.create({
      data: {
        ...
        endDate: new Date("2025-06-02T22:00:00Z"),
        category: ActivityCategory.SIGHTSEEING,
    ...
    prisma.activity.create({
      data: {
        ...
        place: "Port w Pucku",
        startDate: new Date("2025-08-07T14:00:00Z"),
        endDate: new Date("2025-08-07T17:00:00Z"),
        category: ActivityCategory.NATURE,
        tripId: createdTrips[3].id,
        participants: {
          connect: [
    ...
    prisma.activity.create({
      data: {
        ...
        endDate: new Date("2025-08-09T14:00:00Z"),
        category: ActivityCategory.NATURE,
